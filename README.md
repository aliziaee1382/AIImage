...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/imageai)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/imageai
```

A live public deployment of this template is available at [https://imageai.templates.workers.dev](https://imageai.templates.workers.dev)
